...
var CarouselItem = React7.memo(function(props) {
  var mergeProps2 = useMergeProps();
  ...
  return React7.createElement("div", itemClonedProps, content);
});
var Carousel = React7.memo(React7.forwardRef(function(inProps, ref) {
  var mergeProps2 = useMergeProps();
  var context = React7.useContext(PrimeReactContext);
  var props = CarouselBase.getProps(inProps, context);
  var _React$useState = React7.useState(props.numVisible), _React$useState2 = _slicedToArray3(_React$useState, 2), numVisibleState = _React$useState2[0], setNumVisibleState = _React$useState2[1];
  var _React$useState3 = React7.useState(props.numScroll), _React$useState4 = _slicedToArray3(_React$useState3, 2), numScrollState = _React$useState4[0], setNumScrollState = _React$useState4[1];
  var _React$useState5 = React7.useState(props.page * props.numScroll * -1), _React$useState6 = _slicedToArray3(_React$useState5, 2), totalShiftedItemsState = _React$useState6[0], setTotalShiftedItemsState = _React$useState6[1];
  var _React$useState7 = React7.useState(props.page), _React$useState8 = _slicedToArray3(_React$useState7, 2), pageState = _React$useState8[0], setPageState = _React$useState8[1];
  ...
  var itemsContainerRef = React7.useRef(null);
  var remainingItems = React7.useRef(0);
  var allowAutoplay = React7.useRef(!!props.autoplayInterval);
  var attributeSelector = React7.useRef("");
  var swipeThreshold = React7.useRef(20);
  var startPos = React7.useRef(null);
  var interval = React7.useRef(null);
  var carouselStyle = React7.useRef(null);
  var indicatorContent = React7.useRef(null);
  var isRemainingItemsAdded = React7.useRef(false);
  var responsiveOptions = React7.useRef(null);
  ...
  var onRightKey = function onRightKey2() {
    var indicators2 = _toConsumableArray2(DomHandler.find(indicatorContent.current, '[data-pc-section="indicator"]'));
  ...
  var onEndKey = function onEndKey2() {
    var indicators2 = _toConsumableArray2(DomHandler.find(indicatorContent.current, '[data-pc-section="indicator"]r'));
    var activeIndex = findFocusedIndicatorIndex();
  ...
  var createStyle = function createStyle2() {
    ...
    if (props.responsiveOptions) {
      ...
      responsiveOptions.current = _toConsumableArray2(props.responsiveOptions);
    ...
    if (props.value && props.value.length) {
      ...
      if (isCircular) {
        ...
        clonedItemsForStarting = clonedElements.map(function(item2, index) {
          ...
          return React7.createElement(CarouselItem, {
            key,
      ...
      return React7.createElement(React7.Fragment, null, clonedItemsForStarting, items, clonedItemsForFinishing);
    }
  };
  var createHeader = function createHeader2() {
    if (props.header) {
      ...
      return React7.createElement("div", headerProps, props.header);
    }
    return null;
  };
  var createFooter = function createFooter2() {
    if (props.footer) {
      ...
      return React7.createElement("div", footerProps, props.footer);
    }
    return null;
  };
  var createContent = function createContent2() {
    ...
    return React7.createElement("div", containerProps, backwardNavigator, React7.createElement("div", itemsContentProps, React7.createElement("div", _extends6({
  ...
  var createBackwardNavigator = function createBackwardNavigator2() {
    if (props.showNavigators) {
      ...
      var icon = isVertical ? props.prevIcon || React7.createElement(ChevronUpIcon, previousButtonIconProps) : props.prevIcon || React7.createElement(ChevronLeftIcon, previousButtonIconProps);
      var backwardNavigatorIcon = IconUtils.getJSXIcon(icon, _objectSpread3({}, previousButtonIconProps), {
        props
      });
      ...
      return React7.createElement("button", previousButtonProps, backwardNavigatorIcon, React7.createElement(Ripple, null));
    }
    return null;
  };
  var createForwardNavigator = function createForwardNavigator2() {
    if (props.showNavigators) {
      ...
      var icon = isVertical ? props.nextIcon || React7.createElement(ChevronDownIcon, nextButtonIconProps) : props.nextIcon || React7.createElement(ChevronRightIcon, nextButtonIconProps);
      var forwardNavigatorIcon = IconUtils.getJSXIcon(icon, _objectSpread3({}, nextButtonIconProps), {
        props
      });
      ...
      return React7.createElement("button", nextButtonProps, forwardNavigatorIcon, React7.createElement(Ripple, null));
    }
    return null;
  };
  ...
  var createIndicator = function createIndicator2(index) {
    ...
    return React7.createElement("li", _extends6({}, indicatorProps, {
      key
    }), React7.createElement("button", indicatorButtonProps, React7.createElement(Ripple, null)));
  };
  var createIndicators = function createIndicators2() {
    if (props.showIndicators) {
      ...
      return React7.createElement("ul", indicatorsProps, _indicators);
    }
    return null;
  };
  ...
  return React7.createElement("div", rootProps, header, React7.createElement("div", contentProps, content, indicators), footer);
}));
